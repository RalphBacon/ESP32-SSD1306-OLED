...
static uint8_t buffer[SSD1306_LCDHEIGHT * SSD1306_LCDWIDTH / 8] =
		{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			...
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00,
			0x00, 0x80, 0x80, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x80,
			0x80, 0xC0, 0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			...
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0xC0, 0xE0,
			0xF0,
			0xF8, 0xFC, 0xF8, 0xE0, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00,
			0x00, 0x80, 0x80, 0x80, 0x80, 0x80, 0x00, 0x80, 0x80,
			0x00,
			0x00, 0x00, 0x00, 0x80, 0x80, 0x80, 0x80, 0x80, 0x00,
			0xFF,
...
void Adafruit_SSD1306::begin(uint8_t vccstate, uint8_t i2caddr, bool reset) {
	...
	if (sid != -1) {
		...
		// I2C Init - // RSB for ESP32 + OLED SSD1306 module use
		if (!_SDA_PIN){
			Wire.begin();
		}
		else {
			Serial.print("Adafruit_SSD1306::begin - Using SDA pin: "); Serial.println(_SDA_PIN);
			Serial.print("Adafruit_SSD1306::begin - Using SCL pin: "); Serial.println(_SCL_PIN);
...
// RSB allow use on ESP32 with built in SSD1306 OLED module
void Adafruit_SSD1306::I2Cpins(uint8_t User_SDA_PIN, uint8_t User_SCL_PIN) {
	_SDA_PIN = User_SDA_PIN;
	_SCL_PIN = User_SCL_PIN;
}
